...
public class CalculadoraTest {
    ...
    public void testLimite1000() {
        ...
        List<Proposta> propostas = c.calcular(500.00f, 800.00f); //retorna as propostas
    ...
    public void testLimite1001a5000() {
        Calculadora c = new Calculadora();
        List<Proposta> propostas = c.calcular(2000f, 1800.00f); //retorna as propostas
     ...
     @Test
    public void testAcima5000() {
        Calculadora c = new Calculadora();
        List<Proposta> propostas = c.calcular(10000f, 5500.00f); //retorna as propostas
        ...
        assertEquals(4, p2.getNumeroParcelas());
        assertEquals(1787.5, p2.getValorParcelas(), 0.01);
